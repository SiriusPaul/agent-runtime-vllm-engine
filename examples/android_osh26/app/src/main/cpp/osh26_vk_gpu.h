...
struct osh26_vk_stats {
    ...
    bool single_submit_enabled;
    bool last_single_submit_used;
    bool lm_head_q8_enabled;
    char lm_head_path[32];
    char lm_head_memory_path[32];
    uint64_t lm_head_device_local_bytes;
    bool debug_correctness;
    uint32_t gpu_subgroup_size;
    bool gpu_integer_dot_product_supported;
    bool gpu_shader_int8_supported;
    float gpu_timestamp_period_ns;
    uint32_t gpu_timestamp_valid_bits;
    ...
    uint64_t last_descriptor_alloc_count;
    uint64_t last_descriptor_update_count;
    double last_prefix_cache_store_gpu_ms;
    double last_prefix_cache_restore_gpu_ms;
    ...
    double last_lm_head_gpu_ms;
    double last_lm_head_actq8_gpu_ms;
    double last_lm_head_dot_gpu_ms;
    double last_lm_head_topk_gpu_ms;
    double last_lm_head_merge_gpu_ms;

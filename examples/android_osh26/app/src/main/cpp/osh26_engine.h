...
private:
    ...
    double last_prefill_ffn_gate_up_silu_ms_ = 0.0;
    ...
    int last_logits_sanity_fail_count_ = 0;
    std::string last_logits_sanity_reason_;
    double last_gpu_kv_reset_ms_ = 0.0;
    bool last_e2e_compare_ran_ = false;
    bool last_e2e_top1_match_ = false;
    int last_e2e_top5_overlap_ = 0;
    int last_e2e_cpu_top5_[5] = {};
    int last_e2e_gpu_top5_[5] = {};
    float last_e2e_cpu_top1_margin_ = 0.0f;
    double last_e2e_compare_ms_ = 0.0;
    uint64_t last_layer_submit_count_ = 0;
    uint64_t last_lm_head_submit_count_ = 0;
    uint64_t last_ttft_submit_count_ = 0;
    double last_submit_wait_ms_ = 0.0;
